 ...
 * @author jao
 */
public class EditTenantPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(SurnameField);
        SurnameField.setBounds(430, 190, 170, 30);
        ...
        add(FirstnameField);
        FirstnameField.setBounds(430, 220, 170, 30);
        ...
        add(MonthField);
        MonthField.setBounds(420, 250, 60, 27);
        ...
        add(DayField);
        DayField.setBounds(480, 250, 50, 27);
        ...
        add(YearField);
        YearField.setBounds(530, 250, 70, 27);

        jTextField3.setText("jTextField3");
        add(jTextField3);
        jTextField3.setBounds(430, 280, 170, 60);
        ...
        add(jButton3);
        jButton3.setBounds(760, 450, 80, 40);
        ...
        add(jButton2);
        jButton2.setBounds(170, 390, 140, 40);

        imgaddLabel.setText("         Choose photo");
        add(imgaddLabel);
        imgaddLabel.setBounds(160, 220, 160, 160);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/edit-peg.png"))); // NOI18N
        add(jLabel2);
